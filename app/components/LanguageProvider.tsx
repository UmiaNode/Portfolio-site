...
const translations = {
  ja: {
    ...
    about: {
      ...
      skills: [
        ...
        "コーディング（HTML / CSS / JavaScript / GSAP / Astro / WordPress / Next.js / など）",
      ],
      privateWorks: [
        [
          "求人広告LP制作 2,000件以上",
  ...
  os: {
    ...
    value: {
      title: "どこの、どんな、誰に向けんねん",
      body: [
        "デザインするときに大事にしてるんは、ユーザーのことをちゃんと一人の人として想像することです。",
        "",
        "最近は「長いコンテンツは見られへん」と言われがちです。",
        "でも、長いから見られへんのやなくて、見る理由がないまま置かれてることが問題やと思ってます。",
        "",
        "興味を持てる流れがあって、自分ごとやと感じられる内容なら、自然と先へ進んでもらえるはずです。",
        "だから、どこの、どんな、誰に向けて、何を伝えてどんな行動につなげるんかを大切にしてます。",
        "",
        "ユーザー、言葉、情報設計、デザイン、実装。",
        "ユーザーと作り手にとって、ええ感じのWebサイトを目指してます。",
      ],
    },
    works: {
      lead: [
      ...
      items: [
        {
          ...
          challenge: [
            "空手に対して持たれがちな「危なそうやな」という不安や、小さい子でも安心して通えるん？という心配をなくしたる必要がありました。",
          ],
          approach: [
            "習い事探してるお母さんの気持ちを調べて、身体の強さだけやなくて「心の強さを育ててほしい」という気持ちを軸にしました。成長訴求と安心感が両立するように構成、コピー、導線を設計してます。",
          ],
        },
        {
          title: "バンドメンバー募集アプリ Membo",
          ...
          challenge: [
            "機能はようさんあって便利やのに、何を一番に伝えるべきか整理しきれていませんでした。バンド活動を促進するミッションのもと、無難すぎておもんないデザインにはしたくないという要望もありました。",
          ],
          approach: [
            "「音楽をやる理由として、音楽をやりたいから以外にいらんやろ」という衝動に直接届くコピーと構成を考えました。",
            "特定ジャンルに寄りすぎへんように、セクションごとにあえてテイストを変えて、いろんな音楽性を受け止められるLPにしてます。",
          ],
        },
        {
          title: "外国人向け求人媒体 アリガトジョブズ",
          ...
          approach: [
            ...
            "他の求人サービスと競わるんやなく、併用できる選択肢として見てもらえるよう、無料で使える点や導入のしやすさを整理しました。",
          ],
        },
      ],
    },
    about: {
      name: "金森 謙一郎",
      career:
        "2020年から制作会社で合計5年働き、Webデザイン、アートディレクション、フロントエンド実装を担当してきました。2025年に独立し、屋号「UMIA」として活動してます。",
      skills: [
        "Webデザイン / グラフィックデザイン",
        "アートディレクション / 制作ディレクション",
    ...
    contact: {
      lead: "お問い合わせはこちらからどうぞ。通常3営業日以内にお返事させていただきます。",
      name: "お名前",
      email: "メール",
      message: "メッセージ",
      namePlaceholder: "お名前",
      ...
      sending: "送信中です。",
      failed:
        "送信できませんでした。時間をおいてもう一度試してみてください。。",
      missingUrl:
        "送信先が未設定です。NEXT_PUBLIC_GOOGLE_APPS_SCRIPT_URL を設定してください。",
    },
  },
